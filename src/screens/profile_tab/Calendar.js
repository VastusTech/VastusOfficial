...
// import {fetchUserAttributes, forceFetchUserAttributes} from "../../vastuscomponents/redux/actions/userActions";
...
//         if (tags.length === 1) {
//           return (
//             <Image style={{height: '20px', width: '20px'}} size='mini'
//                    src={require('../../vastuscomponents/img/' + tags[0] + '_icon.png')}/>
//           );
...
//                      src={require('../../vastuscomponents/img/' + tags[0] + '_icon.png')}/>
//               <Image style={{height: '20px', width: '20px'}}
//                      src={require('../../vastuscomponents/img/' + tags[1] + '_icon.png')}/>
//             </div>
//           );
...
//                      src={require('../../vastuscomponents/img/' + tags[1] + '_icon.png')}/>
//               <Image style={{height: '20px', width: '20px'}}
//                      src={require('../../vastuscomponents/img/' + tags[2] + '_icon.png')}/>
//             </div>
//           );
//         } else if (tags.length === 4) {
//           return (
//             <div>
//               <Image style={{height: '19px', width: '19px'}}
//                      src={require('../../vastuscomponents/img/' + tags[0] + '_icon.png')}/>
//               <Image style={{height: '19px', width: '19px'}}
//                      src={require('../../vastuscomponents/img/' + tags[1] + '_icon.png')}/>
//               <Image style={{height: '19px', width: '19px'}}
//                      src={require('../../vastuscomponents/img/' + tags[2] + '_icon.png')}/>
//               <Image style={{height: '19px', width: '19px'}}
//                      src={require('../../vastuscomponents/img/' + tags[3] + '_icon.png')}/>
//             </div>
//           );
//         } else {
//           return (
